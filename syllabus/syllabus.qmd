...
**Office Hours:** BRNG 2134; Tuesdays; 1:00–3:00 pm and by appointment
...
This semester, we are going to try using VSCode, an IDE which can write R code. [Our first R Lab](/assignments/r_lab_1_-_installation.qmd) will walk you through installing everything you need.
...
In a flipped class like this, it's really important that folks come prepared to discuss, work through misunderstandings, etc. In order to provide some accountability and space for reflection, each week you will have a review/reflection assignment about the readings and video. You have two options — choose whichever works best for you on a given week.

### Option A: 3-2-1

Write and submit the following on Brightspace:

* **3** concepts you learned or connections you made from this week's reading and lecture
* **2** questions you have or things that you don't quite understand
* **1** question you think would make for a good class discussion question

Post your discussion question to the #discussions channel on Discord as well. Questions should engage with the readings and either connect to other concepts or to the "real world". Here are some good example questions:
...
> "I just read [title/topic] for my Communication and Social Networks class. Ask me questions and have a conversation with me to make sure I understand the most important principles and ideas."
...
2. A short reflection (a paragraph or two): what did you learn from the conversation, and do you still have questions or confusions after it?

As with the 3-2-1, post one discussion question in the #discussions channel on Discord.
...
- **Use AI to understand topics, readings, and concepts.** Have AI explain a confusing passage, ask it to define terms, treat it like a patient tutor. The [Using AI as a Tutor](/assignments/ai_conversation.qmd) assignment is one way to practice this well.
- **Write your own code**  A goal of this class is to help you learn how to do some basic programming. You can ask AI for help in understanding, but copy and paste should only move in one direction - don't copy and paste if AI gives you code. Type it in yourself and make sure that you understand what it does.
