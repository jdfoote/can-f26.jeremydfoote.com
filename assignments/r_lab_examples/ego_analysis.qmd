...
```{r}
edges <- read_excel('/home/jeremy/Teaching/can-f26.jeremydfoote.com/assignments/r_lab_examples/ego_edges.xlsx')
nodes <- read_excel('/home/jeremy/Teaching/can-f26.jeremydfoote.com/assignments/r_lab_examples/ego_atts.xlsx')
```
