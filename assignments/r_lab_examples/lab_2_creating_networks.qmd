...
```{r}
edgelist <- read_excel("/home/jeremy/Teaching/can-f26.jeremydfoote.com/assignments/r_lab_examples/edges.xlsx")
```
...
node_atts <- read_excel("/home/jeremy/Teaching/can-f26.jeremydfoote.com/assignments/r_lab_examples/node_atts.xlsx")
```
...
```{r echo=FALSE}
## YOUR CODE HERE
e2 <- read_excel("/home/jeremy/Teaching/can-f26.jeremydfoote.com/assignments/r_lab_examples/edges_2.xlsx")
n2 <- read_excel("/home/jeremy/Teaching/can-f26.jeremydfoote.com/assignments/r_lab_examples/node_atts_2.xlsx")
