...
nodes = read_csv('https://can-f26.jeremydfoote.com/resources/school_graph_nodes.csv')
edges = read_csv('https://can-f26.jeremydfoote.com/resources/school_graph_edges.csv')
...
nodes = read_csv('https://can-f26.jeremydfoote.com/resources/harry_potter/hp_node_atts.csv')
edges = read_csv('https://can-f26.jeremydfoote.com/resources/harry_potter/hp_edgelist.csv')
